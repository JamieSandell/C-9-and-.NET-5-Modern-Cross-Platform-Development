/*
Create a console application that queries the
Northwind database for all the categories and proucts, and then serializes
that data using at least three formats of serialization available to .NET
