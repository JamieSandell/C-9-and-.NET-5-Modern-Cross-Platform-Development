/*
Create a class library that defines extension
methods that extend number types such as BigInteger and int
with a method named Towards that returns a string describing
the number; for example, 18,000,000 would be eighteen million, and
18,456,002,032,011,000,007 would be eighteen quintillion, four hundred
and fifty-six quadrillion, two trillion, thirty-two billion, eleven million, and
seven.
*/
            ...
            */
            ...
            for (int i = 1; i < groups; ++i)
            {
                ...
                if (digitGroups[i] != 0)
                {
                    ...
                    // Add the three-digit group to combine the string
            ...
            string ThreeDigitGroupToWords(int threeDigits)
            {
                ...
                /*
                    ...
                    hudnreds is added as a word. If the three-digit group is exactly divisible
                    by one hundred, the text 'hundred' is appended. If not, the text
                    "hundred and" is appended. e.g. 'two hundred' or 'one hundred and twelve'
                */

                if (hundreds != 0)
                {
                    groupText += smallNumbers[hundreds] + " hundreds";
