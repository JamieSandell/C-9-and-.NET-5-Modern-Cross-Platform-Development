/* Create a console application project Exercise02 that outputs the number of bytes 
    in memory that each of the following number type uses and the minimum and
    maximum values they can have:
...
namespace Exercise_2._2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"int uses {sizeof(uint)} bytes and can store numbers in the range {uint.MinValue:N0} to {uint.MaxValue:N0}");
